...
extern {
    ...
    pub fn ntru_rand_devrandom_init(rand_ctx: *mut NtruRandContext, rand_gen: *const NtruRandGen)
                                    -> uint8_t;
    #[cfg(not(target_os = "windows"))]
    ...
    #[cfg(not(target_os = "windows"))]
    pub fn ntru_rand_devurandom_init(rand_ctx: *mut NtruRandContext, rand_gen: *const NtruRandGen)
                                     -> uint8_t;
    #[cfg(not(target_os = "windows"))]
    ...
    pub fn ntru_rand_igf2_init(rand_ctx: *mut NtruRandContext, rand_gen: *const NtruRandGen)
                               -> uint8_t;
