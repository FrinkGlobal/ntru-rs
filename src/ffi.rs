...
extern "C" {
    // ntru.h
    pub fn ntru_gen_key_pair(
        params: *const EncParams,
        kp: *mut KeyPair,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    pub fn ntru_gen_key_pair_multi(
        params: *const EncParams,
    ...
    pub fn ntru_sha1_4way(
        input: *const *const uint8_t,
        input_len: uint16_t,
        digest: *mut *mut uint8_t,
    );
    pub fn ntru_sha1_8way(
        input: *const *const uint8_t,
        input_len: uint16_t,
        digest: *mut *mut uint8_t,
    );
    pub fn ntru_sha256(input: *const uint8_t, input_len: uint16_t, digest: *mut uint8_t);
    pub fn ntru_sha256_4way(
        input: *const *const uint8_t,
        input_len: uint16_t,
        digest: *mut *mut uint8_t,
    );
    pub fn ntru_sha256_8way(
        input: *const *const uint8_t,
        input_len: uint16_t,
        digest: *mut *mut uint8_t,
    );
    ...
    pub fn ntru_rand_init_det(
        rand_ctx: *mut RandContext,
        rand_gen: *const RandGen,
        seed: *const uint8_t,
        seed_len: uint16_t,
    ) -> uint8_t;
    pub fn ntru_rand_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    pub fn ntru_rand_wincrypt_init(rand_ctx: *mut RandContext, rand_gen: *const RandGen)
        -> uint8_t;
    #[cfg(target_os = "windows")]
    pub fn ntru_rand_wincrypt_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    pub fn ntru_rand_devrandom_init(
        rand_ctx: *mut RandContext,
        rand_gen: *const RandGen,
    ) -> uint8_t;
    #[cfg(not(target_os = "windows"))]
    pub fn ntru_rand_devrandom_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    #[cfg(not(target_os = "windows"))]
    pub fn ntru_rand_devurandom_init(
        rand_ctx: *mut RandContext,
        rand_gen: *const RandGen,
    ) -> uint8_t;
    #[cfg(not(target_os = "windows"))]
    pub fn ntru_rand_devurandom_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    pub fn ntru_rand_default_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    pub fn ntru_rand_ctr_drbg_init(rand_ctx: *mut RandContext, rand_gen: *const RandGen)
        -> uint8_t;
    pub fn ntru_rand_ctr_drbg_generate(
        rand_data: *mut uint8_t,
        len: uint16_t,
        rand_ctx: *const RandContext,
    ) -> uint8_t;
    ...
    pub fn ntru_mult_tern(
        a: *const IntPoly,
        b: *const TernPoly,
        c: *mut IntPoly,
        mod_mask: uint16_t,
    ) -> uint8_t;
    pub fn ntru_mult_prod(
        a: *const IntPoly,
        b: *const ProdPoly,
        c: *mut IntPoly,
        mod_mask: uint16_t,
    ) -> uint8_t;
    pub fn ntru_mult_priv(
        a: *const PrivPoly,
        b: *const IntPoly,
        c: *mut IntPoly,
        mod_mask: uint16_t,
    ) -> uint8_t;
    pub fn ntru_mult_int(
        a: *const IntPoly,
        b: *const IntPoly,
        c: *mut IntPoly,
        mod_mask: uint16_t,
